...
const playBeep = (success = true) => {
  try {
    ...
    gain.gain.exponentialRampToValueAtTime(
      0.001,
      ctx.currentTime + (success ? 0.15 : 0.4)
    )
...
export default function POSPage() {
  ...
  useEffect(() => {
    if (!searching && !checkoutOpen && !mobileCartOpen) {
      barcodeRef.current?.focus()
    }
  }, [searching, checkoutOpen, mobileCartOpen])
  ...
  return (
    <div className="min-h-screen flex overflow-x-hidden" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        {/* Top bar */}
        <div
          className="px-3 sm:px-4 lg:px-5 py-3 sm:py-4 border-b flex flex-col lg:flex-row lg:items-center gap-3"
          style={{
        ...
        >
          ...
          >
            <div className="relative flex-1 min-w-0">
              ...
              <input
                ...
                className="input-field w-full pl-10 pr-10 sm:pr-4 h-11 font-mono"
            ...
            <motion.button
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="btn-primary h-11 px-4 sm:px-5 shrink-0"
            >
              Add
            </motion.button>
          </form>
          ...
          <div className="flex items-center gap-2 flex-wrap lg:flex-nowrap">
            ...
            <button
              ...
              style={{
                color: soundEnabled ? '#0ea5e9' : 'var(--text-secondary)',
            ...
            <button
              ...
              className="lg:hidden flex items-center gap-2 px-3 h-11 rounded-xl text-sm font-medium transition-all border"
              style={{
                background: 'var(--glass-bg)',
                color: 'var(--text-secondary)',
                borderColor: 'var(--border-color)',
        ...
        <AnimatePresence>
          {scanError && (
            <motion.div
              ...
              className="flex items-center gap-2 px-3 sm:px-5 py-2.5 text-sm"
              style={{
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 overflow-auto">
          <AnimatePresence mode="wait">
            {flashItem ? (
              ...
              >
                <div className="relative w-36 h-36 sm:w-44 sm:h-44 lg:w-48 lg:h-48 mb-6">
                  <div
                ...
                >
                  ...
                  Press{' '}
                  <kbd
                    className="px-1.5 py-0.5 rounded text-xs font-mono mx-1"
                    style={{
                      background: 'var(--glass-bg)',
                ...
                <p
                  className="text-xs mt-3 font-mono px-3 py-1.5 rounded-lg"
                  style={{
                    background: 'var(--glass-bg)',
                    color: 'var(--text-secondary)',
                  }}
      ...
      {/* Desktop cart */}
      <div className="hidden lg:flex lg:w-80 xl:w-96 shrink-0 flex-col overflow-hidden border-l"
        style={{ borderColor: 'var(--border-color)' }}>
      ...
      <AnimatePresence>
        {mobileCartOpen && (
          <>
            ...
            <motion.div
              className="lg:hidden fixed left-0 right-0 bottom-0 z-50 h-[85vh] rounded-t-3xl overflow-hidden border-t"
              style={{
                background: 'var(--bg-secondary)',
                borderColor: 'var(--border-color)',
              }}
